...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <ul>
          <?php 
              ...
              $id = json_decode($json);              
              ?>
          <li><a href="#"><?php  echo "{$id->home}";?></a></li>
          <li><a href="#"><?php  echo "{$id->about_us}";?></a></li>
          <li><a href="#"><?php  echo "{$id->contact_us}";?></a></li>
          <li><a href="#"><?php  echo "{$id->register}";?></a></li>
          <li><a href="#"><?php  echo "{$id->login}";?></a></li>
    ...
    <footer>
      <div class="container">
        <div class="copyright"><?php  echo "{$id->copyright}";?> &copy; 2022</div>
      </div>
    </footer>
  </body>
</html>
